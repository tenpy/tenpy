...
def test_OrthogonalExcitations(tmp_path, switch, group, eps=1.0e-10, N_exc=3):
    ...
    # Z2 charge!
    model_params = dict(L=L, J=1.0, g=g, bc_MPS='finite', conserve='parity', sort_charge=True)
    ...
    sim_params_gs = {
        ...
        'algorithm_params': {'trunc_params': {'chi_max': 30, 'svd_min': 1.0e-8}},
        'group_sites': group,
    }
    ...
    ovs = [
        npc.inner(psi_ED, ED.mps_to_full(psi_DMRG), 'range', do_conj=True)
