...
#  - tenpy v0.x with compiled np_conserved
#  - tenpy v0.x with uncompiled np_conserved
#
# Usage:
...
do
    echo "========================================"
    echo "python $DIR/benchmark.py -m ${MOD}_old $common_args $extra"
    python $DIR/benchmark.py -m ${MOD}_old $common_args $extra
    echo "========================================"
    echo "python $DIR/benchmark.py -m ${MOD}_old_uncompiled $common_args $extra"
    python $DIR/benchmark.py -m ${MOD}_old_uncompiled $common_args $extra
done
