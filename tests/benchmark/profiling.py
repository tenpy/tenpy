...
if __name__ == '__main__':
    ...
    parser.add_argument(
        '-l', '--legs', type=int, default=2, help='Number of legs to be contracted.'
    )
    parser.add_argument(
        '-s', '--sectors', type=int, default=5, help='(Maximal) number of sectors in each leg.'
    )
    parser.add_argument('-S', '--size', type=int, default=50, help='Size of each leg.')
    parser.add_argument(
        '-m', '--modules', nargs='+', default=None, help='Perform profiling for the given modules.'
    )
    parser.add_argument(
        '-p',
        '--print_stats',
    ...
    parser.add_argument(
        '--callees', default=None, help='Print the functions called from inside the given function'
    )
    parser.add_argument(
        '--callers', default=None, help='Print the functions calling the given function'
    )
