...
def contract_to_real_number():
    ...
    res = contract(tensor_list=[v,h2,S,h,w],
                   leg_contractions=[['v','L1','h2','p1*'], ['v', 'L2', 'h2', 'p2*'], ['h2', 'p1', 'h', 'p1*'],
                                     ['h2','p2','S','U'], ['S','L','h','p2*'], ['h', 'p1', 'w', 'U1'],
                                     ['h', 'p2', 'w', 'U2']],
                   open_legs=None,
...
def test_network_contractor():
    for test in [contract_to_real_number, contract_to_complex_number,
                 contract_with_sequence, contract_to_tensor, outer_product]:
        yield test
