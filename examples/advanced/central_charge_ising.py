...
def example_DMRG_tf_ising_infinite_S_xi_scaling(g):
    ...
    for chi in chi_list:
        t0 = time.time()
        eng.reset_stats()  # necessary if you for example have a fixed number of sweeps, if you don't set this you option your simulation stops after initial number of sweeps!
