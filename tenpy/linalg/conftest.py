...
def _get_example_symmetry_sectors(some_symmetry: groups.Symmetry) -> groups.SectorArray:
    ...
    #  JU: - sorted is good practice i think. if a test explicitly wants not sorted for some reason, 
    #        it can do a random permutation...
    #      - IMO, they should be unique *if possible*, but if the symmetry doesnt have enough sectors, they may repeat
    #      - I would return a fixed number, 10 sounds enough.
