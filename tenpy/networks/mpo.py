...
from .mps import MPSEnvironment, TransferMatrix # TransferMatrix only for EnvironmentInitializer
...
class MPO:
    ...
    _charge_perm : {list of 1D arrays | None}
        The inverse permutations obtained by self.sort_legcharges
...
class EnvironmentInitializer():
    ...
    def __init__(self, H, ket):
        self.H = H
        self.ket = ket
        self.dtype = np.find_common_type([H.dtype, ket.dtype], [])
        self.L = self.ket.L
        self.test_sanity()
