...
from .algorithms.mps_common import (
...
from .simulations.ground_state_search import (
...
def _setup_arg_parser(width=None):
    ...
    opt_help = textwrap.dedent("""\
        ...
        argument.""")
    parser.add_argument(
        '--option', '-o', nargs=2, action='append', metavar=('KEY', 'VALUE'), help=opt_help
    )
